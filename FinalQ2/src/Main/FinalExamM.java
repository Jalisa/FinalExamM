...
public class FinalExamM extends JFrame {
	...
	private static JLabel totalGrossIncomeLabel, totalMonthlyDebtLabel,
			...
			maximumPaymentAllowedLabel, mortgageLabel, HousingpaymentFeild;

	private static JTextField totalGrossIncomeTField, totalMonthlyDebtTField,
			mortgageInterestRateTField, termTField, downPaymentTFiel, housingpaymentField,
	...
	public static void Mortgage() {
		...
		downPaymentLabel = new JTextField(10);
